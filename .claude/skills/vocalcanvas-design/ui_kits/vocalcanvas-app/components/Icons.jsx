/* Reusable Lucide-style icon components for VocalCanvas UI kit */
const Icon = ({ children, size = 20, stroke = 1.75, fill = "none", ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
const IconPlay = (p) => <Icon fill="currentColor" stroke="none" {...p}><polygon points="6 4 20 12 6 20 6 4"/></Icon>;
const IconPause = (p) => <Icon fill="currentColor" stroke="none" {...p}><rect x="6" y="5" width="4" height="14" rx="1.5"/><rect x="14" y="5" width="4" height="14" rx="1.5"/></Icon>;
...
const IconHeartFill = (p) => <Icon fill="currentColor" {...p}><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></Icon>;
...
const IconSparkles = (p) => <Icon {...p}><path d="M12 3l1.5 5 5 1.5-5 1.5L12 16l-1.5-5-5-1.5 5-1.5L12 3z"/></Icon>;
...
const IconLibrary = (p) => <Icon {...p}><path d="M16 6l4 14M12 6v14M8 8v12M4 4v16"/></Icon>;
...
const IconMore = (p) => <Icon fill="currentColor" stroke="none" {...p}><circle cx="5" cy="12" r="1.5"/><circle cx="12" cy="12" r="1.5"/><circle cx="19" cy="12" r="1.5"/></Icon>;
const IconHeadphones = (p) => <Icon {...p}><path d="M3 18v-6a9 9 0 0 1 18 0v6"/><path d="M21 19a2 2 0 0 1-2 2h-1v-7h3v5zM3 19a2 2 0 0 0 2 2h1v-7H3v5z"/></Icon>;
const IconSkipBack = (p) => <Icon fill="currentColor" stroke="none" {...p}><polygon points="19 20 9 12 19 4 19 20"/><rect x="5" y="4" width="2" height="16"/></Icon>;
const IconSkipForward = (p) => <Icon fill="currentColor" stroke="none" {...p}><polygon points="5 4 15 12 5 20 5 4"/><rect x="17" y="4" width="2" height="16"/></Icon>;

Object.assign(window, {
  Icon, IconMic, IconPlay, IconPause, IconHeart, IconHeartFill, IconDownload,
  IconPlus, IconTrash, IconSparkles, IconClock, IconSettings, IconLibrary,
  IconChevronLeft, IconChevronRight, IconCheck, IconX, IconMore, IconHeadphones,
