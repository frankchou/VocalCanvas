...
interface IconProps {
  size?: number;
  /** strokeWidth value — use 0 or "none" convention via the `fill` prop on icons that are filled */
...
export const IconHeartFill: React.FC<IconProps> = (p) => (
...
export const IconLibrary: React.FC<IconProps> = (p) => (
  <Icon {...p}>
...
export const IconSkipBack: React.FC<IconProps> = (p) => (
  <Icon fill="currentColor" stroke="none" {...p}>
...
export const IconSkipForward: React.FC<IconProps> = (p) => (
  <Icon fill="currentColor" stroke="none" {...p}>
